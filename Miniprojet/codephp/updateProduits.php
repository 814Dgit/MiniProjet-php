    ...
    <form action="updateProduits.php" method="POST" class="form-horizontal col-lg-6" id="form1">
        ...
        <div class="row">
            <div class="form-group" id="login" id="login">
                ...
                <div class="col-lg-10">
                    <input type="text" name="produit" id="ajout" value="<?php echo @$_POST['produit']; ?>" class="form-control" placeholder="Produit">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group" id="password">
                <label for="Quantite" class="col-lg-2"></label>
                    <div class="col-lg-10">
                        <input type="text" name="quantite" id="ajout" value="<?php echo @$_POST['quantite']; ?>" class="form-control" placeholder="Quantité">
                    </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group" id="password">
                <label for="Prix Unitaire" class="col-lg-2"></label>
                    <div class="col-lg-10">
                        <input type="text" name="prix-unitaire" id="ajout" value="<?php echo @$_POST['prix-unitaire']; ?>" class="form-control" placeholder="Prix Unitaire">
                    </div>
            </div>
        </div>
