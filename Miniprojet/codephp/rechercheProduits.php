    ...
    <form action="rechercheProduits.php" method="POST" class="form-horizontal col-lg-6" id="form1">
        ...
        <div class="row">
            <div class="form-group" id="login" id="login">
                ...
                <div class="col-lg-10">
                    <input type="number" name="quantite" id="ajout" value="<?php echo @$_POST['quantite']; ?>" class="form-control" placeholder="Quantité">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group" id="password">
                <label for="prixMin" class="col-lg-2"></label>
                    <div class="col-lg-10">
                        <input type="number" name="prixMin" id="ajout" value="<?php echo @$_POST['prixMin']; ?>" class="form-control" placeholder="Prix min">
                    </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group" id="password">
                <label for="prixMax" class="col-lg-2"></label>
                    <div class="col-lg-10">
                        <input type="number" name="prixMax" id="ajout" value="<?php echo @$_POST['prixMax']; ?>" class="form-control" placeholder="Prix max">
                    </div>
            </div>
        </div>
